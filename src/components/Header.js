...
function signOut(){
    ...
    return (
        <header className="header">
            ...
            {location.pathname === '/main' && <div className="header__info"><p className="header__email">{email}</p><Link className="header__title" to='/signin' onClick={signOut}>Выйти</Link></div>}  
        </header>
    );
}
